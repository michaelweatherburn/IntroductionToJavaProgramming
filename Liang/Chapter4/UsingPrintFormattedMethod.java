public class UsingPrintFormattedMethod
{
  public static void main(String[] args)
  {
    ...
    /* In case of floating point numbers, there is this takeaway:
      ...
      Notice that the decimal point, if present, also DEMANDS its place in the format. So %7.2f means two places after the decimal point, one place FOR the decimal point, and 7 - 1 - 2 = 4 places (minimum) before the decimal point.
    ...
    */
    ...
    System.out.printf("\n%4.2f", 51.6653);
    //notice that truncation also takes place here.

    System.out.printf("\n%6d", 5432);
    System.out.printf("\n%-6d", 5432);
    // the (minimum) field width information automatically reserves a minimum of places required to show the required character. If you use minus after the percentage symbol, it changes the text orientation to RTL.
